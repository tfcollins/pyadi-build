...
class TestRealZynqMPBoot:
    ...
    def test_real_boot_bin_generation_mocked_tools(self, tmp_path, mocker, real_toolchain_arm64, check_network):
        """
        ...
        config_data = {
            ...
            "boot": {
                "xsa_path": str(tmp_path / "system_top.xsa")
            }
        }
        ...
        def side_effect(cmd, **kwargs):
            ...
            return ExecutionResult(command=str(cmd), return_code=0, stdout="", stderr="", duration=0.0)
        ...
        mocker.patch.object(builder, "_ensure_uboot", return_value=tmp_path / "u-boot.elf")
